...
class Alert(object):
    ...
    def send(self):
        return requests.post(
            ...
            data={
                ...
                "text": "We have a deal {}. To access the alert visit {}".format(
                    self.item.url, "http://{}/alerts/{}".format(AlertConstants.FQDN, self._id))
            }
        )
    ...
    def load_item(self):
        ...
        self.item.get_item_name()
        self.last_checked = datetime.datetime.utcnow()
        self.item.save_to_mongo()
        self.save_to_mongo()
        return self.item.price

    def send_mail_if_price_reached(self):
